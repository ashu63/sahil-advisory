...
export const guide: Guide = {
  ...
  title: 'LLP vs Private Limited vs OPC vs Proprietorship: Which Structure Should You Choose in 2026?',
  h1: 'LLP vs Private Limited vs OPC vs Proprietorship: Which Structure Should You Choose in 2026?',
  metaTitle: 'LLP vs Pvt Ltd vs OPC vs Proprietorship: Which to Choose',
  metaDescription:
    'Compare LLP, Private Limited, OPC and proprietorship on liability, tax rate, audit limits, annual compliance, fundraising and setup cost, with a decision guide.',
  keywords: [
    ...
    'llp tax rate',
    'private limited company tax rate 22%',
    'llp compliance requirements',
    'cost of company registration 2026',
    'business structure for startup india',
  ],
  excerpt:
  ...
  sections: [
    ...
    },
    {
      type: 'stat-grid',
      stats: [
        { label: 'LLP tax rate', value: '30% + 4% cess', note: 'Flat, after partner remuneration under 40(b)' },
        { label: 'Company under 115BAA', value: '22% + 10% + 4%', note: 'Effective 25.17%, no MAT' },
        { label: 'LLP audit threshold', value: '₹40 lakh', note: 'Turnover, or ₹25 lakh contribution' },
        { label: 'Pvt Ltd professional fee', value: '₹6,999', note: 'Plus government fees and stamp duty at actuals' },
      ],
    },
    {
      type: 'tool-card',
      calculatorSlug: 'income-tax',
      text: 'See what your profit would cost in tax if it stayed with you as a proprietor under the new regime, before comparing it with the flat LLP and company rates below.',
    },
    { type: 'heading', text: 'The four structures side by side', id: 'comparison-table' },
    {
      type: 'paragraph',
    ...
    {
      type: 'table',
      head: ['Factor', 'Proprietorship', 'LLP', 'OPC', 'Private Limited'],
      rows: [
      ...
      caption: 'Structure comparison for FY 2026-27',
    },
    { type: 'heading', text: 'Liability and credibility', id: 'liability' },
    {
      type: 'paragraph',
      text: 'A proprietorship has no separate existence. If the business owes money to a supplier, a bank or a customer, the proprietor owes it, and personal assets including the family home are exposed. This is acceptable for a consultant with no inventory and no debt. It is a real risk for a trader carrying stock on credit or a business with employees and premises.',
    },
    {
      type: 'paragraph',
      text: 'LLPs and companies are separate legal persons. Your exposure ends at the capital you contributed or the shares you hold, unless you have signed a personal guarantee for a loan, which banks routinely ask of small companies. Beyond protection, a registered entity carries credibility: corporate customers, marketplaces, lenders and government tenders often require a Private Limited or LLP on the vendor form.',
    },
    { type: 'heading', text: 'Tax: slab versus 30% versus 22%', id: 'tax-comparison' },
    {
      type: 'paragraph',
      text: 'The tax comparison surprises most founders. A proprietor pays at personal slab rates, which under the new regime for FY 2025-26 means nothing up to ₹12 lakh after the 87A rebate, and an average of about 10% on ₹20 lakh. An LLP pays a flat 30% plus 4% cess, but partner remuneration allowed under section 40(b) is deducted first and taxed in the partner hands at slab rates. A company pays 25% (turnover up to ₹400 crore) or a flat 22% under section 115BAA with 10% surcharge and 4% cess, an effective 25.17%, and dividends are then taxed again at the shareholder slab.',
    },
    {
      type: 'example',
      title: 'Tax on ₹20 lakh profit, two equal owners, FY 2025-26',
      lines: [
        { label: 'Proprietorship (one owner, new regime): tax on ₹20 lakh', value: '₹2,00,000' },
        { label: 'Add 4% cess', value: '₹8,000' },
        { label: 'Proprietorship total', value: '₹2,08,000', strong: true },
        { label: 'LLP: remuneration allowed under 40(b) (90% of first ₹6 lakh plus 60% of ₹14 lakh)', value: '₹13,80,000' },
        { label: 'LLP: taxable profit after remuneration', value: '₹6,20,000' },
        { label: 'LLP: tax at 30% plus cess', value: '₹1,93,440' },
        { label: 'Partners: ₹6,90,000 each at slab, rebate 87A applies', value: 'Nil' },
        { label: 'LLP total', value: '₹1,93,440', strong: true },
        { label: 'Company under 115BAA: 22% of ₹20 lakh plus 10% surcharge plus 4% cess', value: '₹5,03,360' },
        { label: 'Company: directors take ₹6.9 lakh salary each instead, taxable profit ₹6.2 lakh', value: '₹1,56,042' },
        { label: 'Company total with salary planning (directors pay nil after 87A)', value: '₹1,56,042', strong: true },
      ],
    },
    {
      type: 'paragraph',
      text: 'The example shows that the structure matters less than how profits are drawn. With salary or remuneration planning, an LLP and a company come close. Without it, the company is expensive because retained profit is taxed at 25.17% and again as dividend at up to 30% when distributed. A proprietor cannot pay themselves a salary, so the slab applies to the whole profit.',
    },
    {
      type: 'callout',
      tone: 'info',
      title: 'Alternate Minimum Tax and MAT',
      text: 'LLPs claiming deductions under sections 10AA, 35AD or 80-IA to 80-IE pay AMT at 18.5% of adjusted total income. Companies not under 115BAA pay MAT at 15% of book profit. A plain services LLP or a company under 115BAA does not meet either.',
    },
    { type: 'heading', text: 'Audit thresholds and who signs', id: 'audit-thresholds' },
    {
      type: 'list',
      items: [
    ...
    { type: 'heading', text: 'Annual compliance calendar', id: 'compliance-calendar' },
    {
      type: 'paragraph',
    ...
    {
      type: 'table',
      head: ['Due date', 'Proprietorship', 'LLP', 'OPC / Private Limited'],
      rows: [
      ...
      caption: 'Recurring compliance by structure, FY 2026-27',
    },
    {
      type: 'paragraph',
      text: 'A newly incorporated company must also file INC-20A declaring commencement of business within 180 days, before it can start operations or borrow. Every company and LLP needs Class 3 digital signatures for its signatories, renewed every two years.',
    },
    { type: 'heading', text: 'Cost of setting up and running each structure', id: 'setup-cost' },
    {
      type: 'table',
      head: ['Cost item', 'Proprietorship', 'LLP', 'OPC', 'Private Limited'],
      rows: [
      ...
      caption: 'Indicative costs in 2026; government fees vary by state and capital',
    },
    {
      type: 'paragraph',
      text: 'The annual figures include return filing, ROC forms and audit fees where mandatory, and exclude GST return filing which depends on volume. The gap between an LLP and a company is almost entirely the statutory audit and the extra ROC forms.',
    },
    { type: 'heading', text: 'Fundraising and ownership', id: 'fundraising' },
    {
      type: 'paragraph',
      text: 'If you expect to raise money from angels or venture funds, or to give employees stock options, the choice is made for you. Investors subscribe to equity or compulsorily convertible preference shares, and only a Private Limited company can issue them. Startup India recognition, 80-IAC tax holiday and angel tax exemption are all designed around companies and LLPs, but term sheets are written for companies.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'service-card',
      serviceSlug: 'pvt-ltd-incorporation',
      text: 'Incorporation with name reservation, MOA and AOA, DSCs, DIN, PAN, TAN, EPFO and ESIC, and a first-year compliance calendar. Not sure yet? Book a 30-minute structuring call first.',
    },
    { type: 'heading', text: 'Converting later: what it costs', id: 'conversion' },
    {
      type: 'paragraph',
      text: 'Starting simple and converting later is a valid plan, as long as you know the conversion rules. Proprietorship to LLP or company is a transfer of business; capital gains are exempt under section 47(xiv) if the proprietor holds at least 50% of the voting power for five years and takes only shares as consideration. LLP to company happens under section 366 of the Companies Act with a fresh incorporation.',
    },
    {
      type: 'paragraph',
      text: 'Company to LLP is possible but the tax exemption under section 47(xiiib) applies only where turnover did not exceed ₹60 lakh in any of the three preceding years and total assets did not exceed ₹5 crore. Above that, the conversion is a taxable transfer. OPC to Private Limited is a simple conversion by adding a member and director, and the reverse is possible when paid-up capital and turnover fall within OPC limits.',
    },
    { type: 'heading', text: 'Decision framework by founder type', id: 'decision-framework' },
    {
      type: 'table',
      head: ['You are', 'Recommended structure', 'Why'],
      rows: [
      ...
      caption: 'Which structure fits which founder',
    },
    {
      type: 'callout',
      tone: 'warning',
      title: 'Do not choose a company for tax savings alone',
      text: 'The 22% rate looks attractive next to a 30% slab, but retained profit still has to reach you as salary or dividend. Salary is taxed at slab and dividend at slab with 10% TDS above ₹10,000. For a founder who withdraws most of the profit, the company rarely saves tax over a proprietorship or LLP once audit and compliance costs are counted.',
    },
    { type: 'heading', text: 'What to do next', id: 'what-to-do-next' },
    {
      type: 'paragraph',
      text: 'Write down three things: how many owners you have today, whether you will take outside equity in the next three years, and how much profit you expect to withdraw versus retain. Those answers point to one row in the table above. If two structures still look equal, book a structuring session, and we will run your numbers through both and hand you a first-year compliance calendar with the incorporation.',
    },
  ],
  faqs: [
    {
      q: 'Which is better, LLP or Private Limited company?',
      a: 'An LLP is better for professional and service businesses that will not raise equity: lower compliance, no audit below ₹40 lakh turnover and deductible partner remuneration. A Private Limited company is better for startups that will raise investment or issue ESOPs, since only a company can issue shares.',
    },
    {
      q: 'What is the tax rate for an LLP in FY 2025-26?',
      a: '30% on total income plus 4% cess, with a 12% surcharge if income exceeds ₹1 crore. Partner remuneration allowed under section 40(b) is deducted before tax and taxed in the partner hands at slab rates, and the share of profit is exempt for partners.',
    },
    {
      q: 'What is the tax rate for a Private Limited company?',
      a: '25% plus surcharge and cess if turnover in FY 2023-24 was up to ₹400 crore, otherwise 30%. Companies can instead opt for 22% under section 115BAA with 10% surcharge and 4% cess, an effective 25.17%, by giving up most deductions and MAT credit.',
    },
    {
      q: 'Is audit compulsory for an LLP?',
      a: 'Only if turnover exceeds ₹40 lakh or partner contribution exceeds ₹25 lakh in the financial year. Below both limits the accounts are unaudited, though Form 8 and Form 11 must still be filed with the Registrar.',
    },
    {
      q: 'How much does it cost to register a Private Limited company in 2026?',
      a: 'About ₹12,000 to ₹20,000 all in: a professional fee of around ₹6,999, two Class 3 DSCs at about ₹1,500 each, and stamp duty on the MOA and AOA that varies by state. MCA charges no fee for authorised capital up to ₹15 lakh.',
    },
    {
      q: 'Can an OPC have more than one owner?',
      a: 'No. A One Person Company has exactly one member and a nominee who takes over on death or incapacity. To add a co-founder or investor the OPC must convert to a Private Limited company, which can now be done at any time.',
    },
    {
      q: 'Can a proprietorship be converted into an LLP or company without tax?',
      a: 'Yes, under section 47(xiv), provided all assets and liabilities are transferred, the proprietor holds at least 50% of voting power for five years and receives only shares or partnership interest as consideration.',
    },
    {
      q: 'What are the annual compliances for a Private Limited company?',
      a: 'At least four board meetings, an AGM by 30 September, AOC-4 within 30 days and MGT-7 within 60 days of the AGM, ADT-1 for auditor appointment, DPT-3 by 30 June, DIR-3 KYC by 30 September, statutory audit and ITR-6 by 31 October, plus GST and TDS returns.',
    },
    {
      q: 'Which structure is best for a freelancer?',
      a: 'A proprietorship using presumptive taxation under 44ADA, where 50% of receipts up to ₹75 lakh is treated as income and taxed at slab rates with the 87A rebate. Registration is not required beyond PAN, and GST applies only above ₹20 lakh.',
    },
  ],
  ...
  relatedCalculators: ['income-tax', 'gst'],
}
